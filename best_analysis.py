...
def yes24_economy(url) :
    ...
    doc = cs.open_sheet()
    worksheet = doc.worksheet('RANK_YES_economy') # select sheet
...
def yes24_humanities(url) :
    
    # URL request possible
    # http://www.yes24.com/24/category/bestseller?CategoryNumber=001001025&sumgb=06&FetchSize=80&PageNumber=1
    doc = cs.open_sheet()
    worksheet = doc.worksheet('RANK_YES_humanities') # select sheet
